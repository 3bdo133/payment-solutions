...
public class ChargesListActivity extends AppCompatActivity {
    ...
    public final String TAG = "ChargesListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.charges_list));
        ...
        mStringRequest = new StringRequest(Request.Method.POST, ContractClass.MY_CHARGES_LIST, new Response.Listener<String>() {
            @Override
        ...
        ChargesListAdapter adapter = new ChargesListAdapter(this, chargeModels, new ChargesListAdapter.OnItemClick() {
            @Override
