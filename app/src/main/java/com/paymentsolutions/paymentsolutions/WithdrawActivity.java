...
public class WithdrawActivity extends AppCompatActivity {
    ...
    public final String TAG = "WithdrawActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) v.findViewById(R.id.title)).setText(getString(R.string.withdraw));
        ...
        mStringRequest = new StringRequest(Request.Method.POST, ContractClass.WITHDRAW_URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                if (response != null && isJSONValid(response)) {
                    if (response.contains("false")) {
                        ...
                        String balanceUpdated = null;
                        try {
                            jsonObject = new JSONObject(response);
                            balanceUpdated = jsonObject.getString("balance_update");
