...
public class MyCustomersActivity extends AppCompatActivity {
    ...
    public final String TAG = "MyCustomersActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MyCustomersAdapter adapter = new MyCustomersAdapter(this, customerModels, new MyCustomersAdapter.OnItemClick() {
            @Override
        ...
        mStringRequest = new StringRequest(Request.Method.POST, ContractClass.MY_CUSTOMERS_URL, new Response.Listener<String>() {
            @Override
                    ...
                    if (response.contains("false")) {
                        ...
                        try {
                            ...
                            for (int i = 0 ;i<jsonArray.length();i++){
                                ...
                                JSONObject user = customer.getJSONObject("User");
                                String name = user.getString("name");
                                String email = user.getString("username");
                                String phone = user.getString("mobile");
                                customerModels.add(new CustomerModel(name,phone,email));
                            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.my_customers,menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.add_cus){
            startActivity(new Intent(this,AddNewCustomerActivity.class).putExtra("id",getIntent().getStringExtra("id")));
            return true;
        } else if (item.getItemId() == R.id.add_current){
            startActivity(new Intent(this,AddCurrentClientActivity.class).putExtra("id",getIntent().getStringExtra("id")));
            return true;
        }
        return false;
    }
